...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li><a href="{{ route('training.all') }}" class="nav-link">Course</a></li>
                <li><a href="{{ route('about') }}" class="nav-link">About</a></li>
                <li><a href="{{ route('contact') }}" class="nav-link">Contact Us</a></li>
                @if(Session::get('student_id'))
                    <li class="dropdown">
                        <a href="{{ route('login-registration') }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">{{ Session::get('student_name') }}</a>
                    <ul class="dropdown-menu">
    ...
    <footer class="pt-5 pb-3 bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card footer-card card-body h-100 bg-dark text-white border-0">
                        <h1>OTMS</h1>
        ...
        <section class="footer-end pt-3">
            <div class="row border-top pt-3">
                <div class="col">
                    <p class="text-white text-center mb-0 pb-0">Copyright © 2022 Develop & Design By <a href="" class="text-decoration-none">Sarker Majid</a></p>
                </div>
            </div>
        </section>
    </footer>
